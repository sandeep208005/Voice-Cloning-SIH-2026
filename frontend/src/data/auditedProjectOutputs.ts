import { ProjectOutputsResponse, DashboardStatistics, RecentAnalysisItem } from '../types';

export const AUDITED_PROJECT_OUTPUTS: ProjectOutputsResponse = {
  status: "success",
...
export const AUDITED_DASHBOARD_SNAPSHOT: {
